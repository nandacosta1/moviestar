...
<body>
    <header>
        <nav id="main-navbar" class="navbar navbar-expand-lg">
            ...
            <button class="navbar-toggler" type="button" data-toggler="collapse" data-target="#navabr" aria-controls="navbar" aria-expanded="false" aria-label="toggle navigation">
